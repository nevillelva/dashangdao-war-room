...
@st.cache_data(ttl=3600, show_spinner="[連線中] 獲取籌碼記憶矩陣...")
...
# ==========================================
with st.sidebar:
    if st.button("⚡ 強制全域更新 (清除快取)", help="立刻清除快取，抓取最新大盤與個股即時數據", use_container_width=True, type="primary"):
