...
                        elif val < 0 and t_cs == 0: t_cs += 1; t_vs += val / 1000
                        else: break
    except Exception: pass
...
                    elif cmd_name == "指令畫" or cmd_name == "指令四":
                        if d['t_buy'] > 0 and any("集團" in t['text'] or "熱門" in t.get('title','') for t in d.get('ai_tags_dict', [])): results.append(d)
