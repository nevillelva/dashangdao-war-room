...
# 基礎配置與狀態初始化
# ==========================================
st.set_page_config(layout="wide", page_title="54088 - 戰情室 V79.0", initial_sidebar_state="expanded")
...
with col_nav1: st.markdown("<h1 style='color:#FFB300; margin: 0;'>54088 戰情室 V79.0 (作帳防護版)</h1>", unsafe_allow_html=True)
with col_nav2:
