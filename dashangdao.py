...
# 基礎配置與狀態初始化
# ==========================================
st.set_page_config(layout="wide", page_title="54088 - 戰情室 V97.0", initial_sidebar_state="expanded")

# [防白屏機制] 強制送出前端開機訊號
st.toast("[系統提示] V97.0 絕對防禦校正版 啟動成功，正在載入核心數據...")
...
def calculate_signals(symbol, data_tuple, portfolio_data=None, is_panic_global=False, twii_gain=0.0, is_scan=False):
    # [絕對防禦] 將集團資料庫封裝於函數內部，徹底免疫快取記憶體遺失
    INTERNAL_SECTORS_DB = {
...
with col_nav1: st.markdown("<h1 style='color:#FFB300; margin: 0;'>54088 戰情室 V97.0 (絕對防禦校正版)</h1>", unsafe_allow_html=True)
with col_nav2:
